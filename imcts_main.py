...
import utils
import models
from models.incts import Model
import argparse
...
def train(model):
    ...
    logger.info('Best MRE - {}'.format(np.min(brits_test_mae_history)))
...
def run():
    ...
    model = Model(args.hid_size, args.impute_weight, args.label_weight, args.NUM_FEATURES, args.dropout_rate)
